...
public class ArtistListAdapter extends RecyclerView.Adapter<ArtistListAdapter.ViewHolder> {
    ...
    ArrayList<ArtistPojo> artistListingPojoArrayList;

    public ArtistListAdapter(Context context, ArrayList<ArtistPojo> artistListingPojoArrayListn) {
        this.context = context;
       artistListingPojoArrayList = artistListingPojoArrayListn;
    }
    ...
    public void onBindViewHolder(final ViewHolder viewHolder, final int position) {
        ...
        viewHolder.tv_name.setText(artistListingPojoArrayList.get(position).getName());
    }
    ...
    public int getItemCount() {
        return artistListingPojoArrayList.size();
    }
}